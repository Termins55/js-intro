...
// створити мапу з обʼєкта
const obj = { Test: "380123456789", Test1: "380123456788" };
...
//   // отримати масив англомовних слів ['dog', 'run', 'white', 'cat']
...
const ukrPhrase = translateEngToUa(engPhrase); // 'собака бігає кіт'
