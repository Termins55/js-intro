...
// + для обʼєктів (вийняток)

// перетворення одного типу ітерованої колекції в інший
function sum() {
  const arrFromArguments = [...arguments]; // Перетворили argument на Array
...
sendData({ id: 2, tel: "+380123456788" }, { port: 5005 });
